...
import { Clock, User, Mail, Phone, Calendar, MessageSquare } from 'lucide-react'
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-500">문의 번호</Label>
          ...
          <div className="space-y-2">
            <Label className="text-sm font-medium text-gray-500">연락처 정보</Label>
      ...
      {replies.length === 0 && inquiry.status === 'pending' && (
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-sm text-yellow-700">관리자 답변을 기다리고 있습니다</p>
          </CardContent>
        </Card>
      )}
