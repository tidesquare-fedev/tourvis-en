...
export function InquiryList({ inquiries, onInquirySelect, selectedInquiryId }: InquiryListProps) {
          ...
          filteredInquiries.map((inquiry) => (
            <Card 
              ...
              className={`cursor-pointer transition-colors hover:bg-gray-50 ${
                selectedInquiryId === inquiry.id ? 'ring-2 ring-blue-500 bg-blue-50' : ''
              }`}
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <h3 className="font-medium text-sm truncate">{inquiry.subject}</h3>
                    </div>
                    
                    <div className="text-xs text-gray-500 mb-2">
                      {inquiry.author} ({inquiry.name}) • {formatDate(inquiry.created_at)}
                    </div>
