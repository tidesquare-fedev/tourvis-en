...
export const queryKeys = {
  ...
  activity: {
    ...
    product: (id: string) =>
      [...queryKeys.activity.all, 'product', id] as const,
  ...
  tna: {
    ...
    productDetail: (productId: string) =>
      [...queryKeys.tna.all, 'productDetail', productId] as const,
  ...
  inquiry: {
    ...
    list: (params: Record<string, any>) =>
      [...queryKeys.inquiry.all, 'list', params] as const,
...
export const cacheUtils = {
  ...
  invalidateProduct: (productId: string) => {
    return Promise.all([
      ...
      queryClient.invalidateQueries({
        queryKey: queryKeys.tna.productDetail(productId),
      }),
      queryClient.invalidateQueries({
        queryKey: [...queryKeys.tna.all, 'options'],
      }),
      queryClient.invalidateQueries({
        queryKey: [...queryKeys.tna.all, 'price'],
      }),
    ]);
  },
