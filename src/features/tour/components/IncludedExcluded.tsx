...
export function IncludedExcluded({ included, excluded }: IncludedExcludedProps) {
  // 값이 있는 항목만 필터링
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-xl font-semibold text-gray-900">What's Included & Not Included</h3>
      </div>
      
      <div className={`grid gap-8 ${hasIncluded && hasExcluded ? 'grid-cols-1 lg:grid-cols-2' : 'grid-cols-1'}`}>
