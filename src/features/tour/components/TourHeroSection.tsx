...
import { MapPin, Star, Clock, Users, Globe, Eye, X, ChevronLeft, ChevronRight, Quote } from 'lucide-react'
...
export function TourHeroSection({ tourData, tour, starColor, onScrollToReviews, maskName }: TourHeroSectionProps) {
  ...
  const handlePreviousImage = () => {
    setCurrentMainImageIndex((prev) => (prev > 0 ? prev - 1 : allImages.length - 1))
  }

  const handleNextImage = () => {
    setCurrentMainImageIndex((prev) => (prev < allImages.length - 1 ? prev + 1 : 0))
  }
  ...
  useEffect(() => {
    ...
    const scrollToThumbnail = () => {
      ...
      const selectedThumbnail = thumbnailContainer.children[selectedImageIndex] as HTMLElement
      if (!selectedThumbnail) return

      console.log('Scrolling to thumbnail:', selectedImageIndex, 'Total thumbnails:', thumbnailContainer.children.length)
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="order-1 lg:order-1">
            <div className="relative group">
              <img
                src={allImages[currentMainImageIndex]?.file_url || allImages[currentMainImageIndex]}
                alt={tour.title}
          ...
          <div className="bg-white rounded-lg shadow-2xl max-w-6xl max-h-[90vh] w-full flex flex-col">
            ...
            <div className="flex-1 relative overflow-hidden">
              ...
              <div className="relative h-full flex items-center justify-center bg-gray-50">
                <img
                  src={allImages[selectedImageIndex]?.file_url || allImages[selectedImageIndex]}
            ...
            {allImages.length > 1 && (
              <div className="p-4 border-t border-gray-200">
                <div ref={thumbnailRef} className="flex gap-2 overflow-x-auto scrollbar-hide snap-x snap-mandatory">
