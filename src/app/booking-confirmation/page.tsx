  ...
  useEffect(() => {
    ...
    if (reservationNumber) {
      ...
      if (saved) {
        ...
        if (!parsed.activityDetails)
          parsed.activityDetails =
            createMockReservation(reservationNumber).activityDetails;
    ...
    <div className="min-h-screen bg-white">
      <header className="sticky top-0 z-50 bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between">
          ...
          <span
            className="logo h-6 sm:h-8 w-24 sm:w-28 ml-auto md:ml-0"
            role="img"
            aria-label="TOURVIS"
          />
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-lg text-gray-600">
            Thank you for booking with KoreaTours. Your reservation has been
            confirmed.
          </p>
        </div>
        ...
        <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3 sm:space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm sm:text-base">
                    {reservation.participants} person(s)
                  </span>
                </div>
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-right max-w-xs text-sm sm:text-base">
            ...
            <Card>
              ...
              <CardContent className="space-y-3 sm:space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-right text-sm sm:text-base break-all">
                    {reservation.email}
                  </span>
                </div>
                <div className="flex justify-between items-center">
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex justify-between text-sm sm:text-base">
                  <span>
                    ${reservation.tourPrice} × {reservation.participants}{' '}
                    person(s)
                  </span>
            ...
            <CardContent className="space-y-4">
              <div className="bg-blue-50 p-3 sm:p-4 rounded-lg">
                ...
                <ul className="text-xs sm:text-sm text-blue-700 space-y-1">
                  ...
                  <li>
                    • Bring comfortable hiking shoes and weather-appropriate
                    clothing
                  </li>
                  <li>
              ...
              <div className="bg-yellow-50 p-3 sm:p-4 rounded-lg">
                ...
                <p className="text-xs sm:text-sm text-yellow-700">
                  ...
                  Contact us at info@koreatours.com for cancellations or
                  changes.
                </p>
              </div>
            </CardContent>
          ...
          <div className="text-center mt-6 sm:mt-8 space-y-3 sm:space-y-0 sm:space-x-4 flex flex-col sm:flex-row sm:justify-center">
            ...
            <Link href="/reservation-lookup" className="w-full sm:w-auto">
