...
export default async function TourDetailPage({ params }: TourDetailPageProps) {
  ...
  const getMockTourData = (id: string): TourApiResponse => {
    if (id === 'PRD2001371482') {
      ...
      return {
        basic: {
          ...
          reviews: [
            {
              ...
              rating: 5,
              comment:
                '정말 의미있는 투어였습니다. 가이드분이 친절하고 설명도 잘해주셨어요.',
              date: '2024-01-15',
              helpful: 8,
            },
            {
          ...
          additional_info:
            '예약 시 제공된 이름과 입장 시 제시한 신분증의 이름이 일치해야 합니다.',
          images: [
        ...
        detail: {
          ...
          notice_detail: null,
          highlight_title:
            '아우슈비츠-비르케나우 가이드 투어를 통해 20세기 유럽 역사에서 가장 어두운 장 중 하나였던 아우슈비츠를 탐험하세요. 가이드의 도움을 받아 강제 수용소의 원래 건물을 둘러보세요.',
          highlight_detail:
            '<ul><li>제2차 세계대전 당시 유럽의 어두운 역사 탐험하기</li><li>아우슈비츠와 비르케나우 강제 수용소를 가슴 아프게 둘러보세요.</li><li>나치가 잔학 행위를 저지른 장소를 확인하고 희생자들의 개인 유물을 살펴보세요.</li></ul>',
          highlights: [
            '아우슈비츠 제1 수용소 방문',
            '비르케나우 수용소 투어',
            '전문 가이드 설명',
          ...
          itinerary: [
            ...
            },
            {
              ...
              title: '아우슈비츠 제1 수용소',
              description:
                '아우슈비츠 제1 수용소를 둘러보며 역사적 의미를 되새깁니다.',
              duration: '2시간',
              activities: [
                '노동의 대가 표지판 관람',
                '관리 건물 방문',
            ...
            },
            {
              ...
              title: '비르케나우 수용소',
              description:
                '비르케나우 수용소에서 수감자들의 생활을 엿볼 수 있습니다.',
              duration: '1시간',
              activities: [
                '수용소 입구 방문',
                '나무 막사 관람',
          ...
          additional_fields: [
            {
              ...
              title: '미팅포인트',
              content:
                "<p><p>미팅 포인트는 예약한 옵션에 따라 다를 수 있습니다.</p><br><ul><li><b>선택한 미팅 포인트에서 출발하는 프랑스어 가이드 투어</b> <a href='https://maps.google.com/?q=50.0592719,19.9428865' target='_blank' >(구글맵 바로가기)</a></br><br>위엘로폴 2 (키스&라이드 정류장)</li></ul><p>",
            },
            {
              key: 'notSuitable',
              title: '참가가 어려워요',
          ...
          options: [
            {
              ...
              description:
                '원하는 출발 시간과 미팅 장소를 선택하세요. 오전 6시에서 오후 1시 30분 사이에 출발이 가능합니다. 원하는 시간이 보장되는 것은 아닙니다. 투어 하루 전에 정확한 출발 시간을 알려드립니다.',
              per_min: 1,
              per_max: 5014,
            ...
            },
            {
              ...
              description:
                '호텔과 원하는 출발 시간을 선택하세요. 오전 6시~오후 1시 30분 사이에 출발 가능합니다. 원하는 시간을 선택하실 수 있지만 보장되지 않습니다. 투어 하루 전에 정확한 출발 시간을 알려드립니다.',
              per_min: 1,
              per_max: 5014,
            ...
            },
            {
              ...
              description:
                '원하는 출발 시간과 크라쿠프 시내의 여러 미팅 포인트 중 하나를 선택하세요. 오전 6시부터 오후 1시 30분 사이에 출발하실 수 있습니다. 원하는 시간이 보장되는 것은 아닙니다. 투어 하루 전에 정확한 출발 시간을 알려드립니다.',
              per_min: 1,
              per_max: 5014,
            ...
            },
            {
              ...
              description:
                '미팅 장소와 원하는 출발 시간을 선택하세요. 당사는 이를 보장할 수는 없지만 최선을 다해 조정합니다. 투어 하루 전에 정확한 출발 시간을 알려드립니다. 오전 6시~오후 1시 30분 사이에 출발이 가능합니다.',
              per_min: 1,
              per_max: 5014,
    ...
    return {
      basic: {
        ...
        excluded: ['개인 비용', '팁 (선택사항)', '식사'],
        bring_items: ['편한 신발', '여권 또는 신분증(사본 허용)'],
        not_allowed: ['반바지', '짧은 치마', '민소매 셔츠'],
        not_suitable: ['휠체어 사용자'],
        additional_info:
          '바티칸 박물관은 세계에서 가장 유명한 박물관 중 하나입니다. 미켈란젤로의 시스티나 성당과 라파엘로의 방들을 포함한 수많은 예술 작품을 감상할 수 있습니다.',
        images: [
        ...
        reviews: [
          {
            ...
            date: '2025.06.09',
            comment:
              '정말 좋은 경험이었습니다. 가이드가 친절하고 시스티나 성당이 너무 아름다웠어요!',
            helpful: 31,
          },
          {
            id: 2,
            ...
            date: '2025.06.16',
            comment:
              '바티칸 박물관의 예술 작품들이 정말 인상적이었습니다. 우선입장으로 대기시간 없이 관람할 수 있어서 좋았어요.',
            helpful: 15,
          },
          {
            id: 3,
            ...
            date: '2025.04.10',
            comment:
              '성 베드로 대성당까지 포함된 투어로 정말 알찬 하루였습니다. 추천합니다!',
            helpful: 8,
          },
          {
            id: 4,
            ...
            date: '2025.03.18',
            comment:
              '소그룹으로 진행되어 더욱 집중해서 관람할 수 있었습니다. 가이드님이 역사적 배경도 잘 설명해주셨어요.',
            helpful: 12,
          },
          {
            id: 5,
            ...
            date: '2025.05.22',
            comment:
              '가이드의 설명이 매우 상세했고, 미켈란젤로의 작품을 직접 볼 수 있어서 감동적이었습니다.',
            helpful: 12,
          },
        ],
        price: 0,
      ...
      detail: {
        ...
        notice_detail: null,
        highlight_title:
          '바티칸 박물관과 시스티나 성당을 우선입장하고 성 베드로 대성당 방문을 선택하실 수 있습니다. 원하는 체험을 선택하고 스트레스 없이 바티칸의 걸작을 둘러보세요.',
        highlight_detail:
          '<ul><li>바티칸 박물관의 주요 명소를 우선 입장할 수 있습니다.</li><li>바티칸의 지도 갤러리, 거대한 타피스트리, 고대 로툰다 조각상을 감상하세요.</li><li>시스티나 성당에서 미켈란젤로의 걸작들을 감상하세요.</li><li>피에타와 베르니니의 발다키니를 포함한 성 베드로 대성당을 탐험하기 위해 업그레이드하세요.</li><li>전문가 안내로 진행되는 스토리텔링을 통해 바티칸의 예술과 역사가 생생하게 살아납니다.</li></ul>',
        event: '',
        description:
          '<p>바티칸은 매우 넓고, 솔직히 말해 혼자 탐험하기에는 압도적일 수 있습니다. 바로 이 때문에 저희 전문 가이드가 함께합니다. 주요 명소를 직접 안내해 드려 놓치는 것 없이 완벽한 경험을 선사합니다.<br><br>놀라운 바티칸 박물관에서 독점적인 우선입장 혜택을 누리며 세기의 예술, 역사, 숨막히는 천장 예술이 가득한 보물 창고를 탐험하세요. 함께 걸어갈 곳은:<br><br>벽걸이 갤러리: 거대한 복잡하게 엮인 걸작들이 놀라운 이야기를 전합니다.<br><br>다음으로 숨막히는 시스티나 성당으로 들어갑니다. 사진은 봤을지 몰라도, 미켈란젤로의 아이콘적인 프레스코화 아래 서 있는 것은 비교할 수 없습니다. "아담의 창조"와 "최후의 심판"을 올려다보며, 미켈란젤로가 모든 놀라운 세부 사항을 열심히 그렸을 모습을 상상해 보세요.<br><br>전체 체험을 선택하신 분들은 미켈란젤로의 감동적인 피에타와 베르니니의 화려한 청동 발다키노가 있는 위풍당당한 성 베드로 대성당으로 계속 진행하세요.<br><br>여행은 대성당 밖에서 마무리되며, 성 베드로 광장을 탐험하거나 근처의 카스텔 산탄젤로를 여유롭게 탐방할 수 있는 충분한 시간이 주어집니다.<p>',
        highlights: [
        ...
        itinerary: [
          {
            ...
            title: '바티칸 박물관 투어',
            description:
              '바티칸 박물관의 주요 전시실들을 순회하며 수많은 예술 작품을 감상합니다.',
            duration: '4시간',
            activities: [
              '09:00 - 미팅 포인트에서 만남',
              '09:30 - 바티칸 박물관 우선 입장',
        ...
        options: [
          {
            ...
            description:
              '활기찬 그룹과 영어를 구사하는 전문 가이드와 함께 바티칸을 탐험하세요. 우선입장 혜택을 누리며 바티칸 박물관, 시스티나 성당, 라파엘 방을 재미있고 사교적인 분위기에서 둘러보세요.',
            per_min: 1,
            per_max: 5230,
          ...
          },
          {
            code: 'OPT3007903821',
            title:
              '바티칸 박물관 & 시스티나 성당 프랑스어 투어(바티칸 대성당 없음)',
            description:
              '활기찬 그룹과 프랑스어 전문 가이드와 함께 바티칸을 탐험하세요. 우선입장 혜택을 누리며 바티칸 박물관, 시스티나 성당, 라파엘 방을 재미있고 사교적인 분위기에서 둘러보세요.',
            per_min: 1,
            per_max: 5230,
          ...
          },
          {
            ...
            description:
              '활기찬 그룹과 스페인어를 구사하는 전문 가이드와 함께 바티칸을 탐험하세요. 우선입장 혜택을 누리며 바티칸 박물관, 시스티나 성당, 라파엘 방을 재미있고 사교적인 분위기에서 둘러보세요.',
            per_min: 1,
            per_max: 5230,
          ...
          },
          {
            ...
            description:
              '독일어 가이드 투어로 바티칸 박물관과 시스티나 성당을 우선입장하여 하루를 알차게 보내세요.',
            per_min: 1,
            per_max: 5230,
          ...
          },
          {
            ...
            description:
              '바티칸 시국이 제공하는 모든 것을 탐험해 보세요. 바티칸 박물관, 시스티나 성당, 성 베드로 대성당에 대한 우선입장권과 독일어 전문 가이드가 있어 대기 시간을 줄이고 바로 관람할 수 있습니다.',
            per_min: 1,
            per_max: 5230,
  ...
  try {
    ...
    if (base.basic.display_price?.price2 != null)
      base.basic.price = Number(base.basic.display_price.price2);
    if (base.basic.display_price?.price1 != null)
      base.basic.originalPrice = Number(base.basic.display_price.price1);
    ...
    base.detail.additional_info = String(
    ...
    if (refundDetail && typeof refundDetail === 'object') {
      ...
      base.refund.cancel_type = String(
        refundDetail?.cancel_type ?? base.refund.cancel_type ?? '',
      );
      base.refund.cancel_time = String(
        refundDetail?.cancel_time ?? base.refund.cancel_time ?? '',
      );
      ...
      if (Array.isArray(datesRes)) {
        if (datesRes.length > 0 && typeof datesRes[0] === 'object') {
          ...
          base.basic.available_dates = list
            ...
            .filter(Boolean);
          base.basic.available_dates.forEach(d => {
            stateMap[d] = 'OPEN';
          });
