...
import { ArrowLeft, MessageCircle, Clock, CheckCircle, XCircle, Lock } from 'lucide-react'
...
export default function InquiryDetailPage() {
  ...
  const authenticateAndLoadInquiry = async (author: string, password: string) => {
    try {
      setAuthLoading(true)
      ...
      if (result.success) {
        const targetInquiry = result.inquiries.find((inq: InquiryDetail) => inq.id === inquiryId)
        if (targetInquiry) {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      default:
        return <Badge variant="secondary" className="bg-gray-100 text-gray-800">알 수 없음</Badge>
    }
  }
      ...
      <LayoutProvider>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Inquiry Authentication</h1>
            <p className="text-base sm:text-lg text-gray-600">Enter your credentials to view this inquiry</p>
          </div>
          ...
          <Card className="max-w-md mx-auto">
            ...
            <CardContent>
              <form onSubmit={handleAuthSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={authLoading} style={{ backgroundColor: '#01c5fd' }}>
      ...
      <LayoutProvider>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">The requested inquiry could not be found.</p>
        ...
        {replies.length === 0 && inquiry.status === 'pending' && (
          <Card>
            <CardContent className="text-center py-8">
              ...
              <p className="text-gray-600">Your inquiry is being reviewed. We will respond within 24 hours.</p>
            </CardContent>
          </Card>
        )}
      </div>
